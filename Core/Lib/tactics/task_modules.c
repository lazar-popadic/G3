...
case 0:
  ...
  move_to_xy (solar_central.x - (2 * side - 1) * 250, solar_central.y + 20,
	      first_dir);
  if (movement_finished () && timer_delay_nonblocking (20))
    {
      task_case++;
...
case 0:
  ...
  move_to_xy (solar_central.x + (2 * side - 1) * 230, solar_central.y + 20,
	      first_dir);
  if (movement_finished () && timer_delay_nonblocking (100))
    {
      task_case++;
...
case 4:
  ...
  move_full (solar_central.x - (2 * side - 1) * 45, solar_central.y + 20,
	     side * 180,
	     WALL);
  if (movement_finished () && timer_delay_nonblocking (100))
    {
...
case 6:
  ...
  break;
case 7:
  move_full (solar_central.x - (2 * side - 1) * 270, solar_central.y + 20,
	     side * 180,
	     WALL);
  if (movement_finished () && timer_delay_nonblocking (100))
    {
