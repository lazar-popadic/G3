...
xl_move (uint8_t id, uint16_t angle, uint16_t speed)
{
  ...
  uint8_t xl_move_no_crc[] =
    { 0xff, 0xff, 0xfd, 0x00, id, 0x09, 0x00, 0x03, 0x1e, 0x00, angle_low,
	angle_high, speed_low, speed_high };

  uint8_t crc16, crc_l, crc_h;
  crc16 = update_crc (0, xl_move_no_crc, 14);
  crc_l = crc16 & 0x00FF;
  crc_h = (crc16 >> 8) & 0x00FF;

  uint8_t xl_move[] =
    { 0xff, 0xff, 0xfd, 0x00, id, 0x09, 0x00, 0x03, 0x1e, 0x00, angle_low,
	angle_high, speed_low, speed_high, crc_l, crc_h };
